                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                        <div>
                            ...
                            <h5 class="mb-2 text-white op-7">
                                Welcome, {{ Auth('admin')->User()->firstName }} {{ Auth('admin')->User()->lastName }}!
                            </h5>
                        </div>

                        @if (Auth('admin')->User()->type == 'Super Admin' || Auth('admin')->User()->type == 'Admin')
                            <div class="py-2 ml-md-auto py-md-0">
                                {{-- Routes corrected to match the names in the route file --}}
                                <a href="{{ route('mdeposits') }}" class="mr-2 btn btn-success">Deposits</a>
                                <a href="{{ route('mwithdrawals') }}" class="mr-2 btn btn-info">Transfers</a>
