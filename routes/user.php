...
use App\Http\Controllers\CryptoController; // NEW: Import the new CryptoController
...
Route::middleware(['auth:sanctum', 'verified'])->prefix('dashboard')->group(function () {
	...
	Route::middleware('complete.kyc')->group(function () {
        ...
        Route::post('fundcard', [ViewsController::class, 'fundcard'])->name('fundcard');
        
        
        
         Route::post('cardfund', [ViewsController::class, 'cardfund'])->name('cardfund');
          Route::post('cardwithdrawal', [ViewsController::class, 'cardwithdrawal'])->name('cardwithdrawal');
          
           Route::post('withdrawcard', [ViewsController::class, 'withdrawcard'])->name('withdrawcard');
		...
		Route::get('verification1', [ViewsController::class, 'code1'])->name('code1verification');
		Route::get('verification2', [ViewsController::class, 'code2'])->name('verificationcode2');
		Route::get('verification3', [ViewsController::class, 'code3'])->name('verification3code');
        ...
        Route::get('myshares', [ViewsController::class, 'myshares'])->name('myshares');
        Route::get('digitalplan', [ViewsController::class, 'sharesplan'])->name('sharesplan');
        ...
        // NEW: Bitcoin (BTC) related routes
        Route::get('/swap', [CryptoController::class, 'showSwapPage'])->name('swap');
        Route::post('/swap/process', [CryptoController::class, 'processSwap'])->name('process-swap');
        Route::get('/send-btc', [CryptoController::class, 'showSendBtcPage'])->name('send-btc');
        Route::post('/send-btc/process', [CryptoController::class, 'processSendBtc'])->name('process-send-btc');
	});
});
