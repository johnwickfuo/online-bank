...
Route::middleware(['isadmin', '2fa'])->prefix('admin')->group(function () {
	...
	Route::get('/dashboard/active-investments', [HomeController::class, 'activeInvestments'])->name('activeinvestments');
     Route::get('/dashboard/UserInvestment', [HomeController::class, 'UserInvestment'])->name('UserInvestment');
    ...
    Route::post('dashboard/update-withdrawal-status/{id}', [ManageWithdrawalController::class, 'updateWithdrawalStatus'])->name('admin.update-withdrawal-status');
    ...
    //userinvestment
    Route::get('dashboard/deleteuserinvestment/{id}', [ManageUsersController::class, 'deleteuserinvestment'])->name('deleteuserinvestment');
    Route::get('dashboard/approveuserinvestment/{id}', [ManageUsersController::class, 'approveuserinvestment'])->name('approveuserinvestment');
      Route::get('dashboard/markuserinvestment/{status}/{id}', [ManageUsersController::class, 'markuserinvestment'])->name('markuserinvestment');

      Route::get('dashboard/userinvestmentplan/{id}',  [HomeController::class, 'userinvestmentplan'])->name('userinvestmentplan');
