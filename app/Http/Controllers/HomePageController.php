...
public function mortgages(){
    ...
    return view('home.mortgages',)->with(array(
        'title' => 'Mortgages',
        'settings' => Settings::where('id', '=', '1')->first(),
));
...
public function insurance(){
    ...
    return view('home.insurance',)->with(array(
        'title' => 'Insurance',
        'settings' => Settings::where('id', '=', '1')->first(),
));
...
public function savings(){
    ...
    return view('home.savings',)->with(array(
        'title' => 'Savings',
        'settings' => Settings::where('id', '=', '1')->first(),
));
...
public function private(){
    ...
    return view('home.private',)->with(array(
        'title' => 'Cooperote Private',
        'settings' => Settings::where('id', '=', '1')->first(),
));
...
public function cooperate(){
    ...
    return view('home.cooperate',)->with(array(
        'title' => 'Cooperote Private',
        'settings' => Settings::where('id', '=', '1')->first(),
));
