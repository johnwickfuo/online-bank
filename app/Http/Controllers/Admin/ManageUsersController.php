...
class ManageUsersController extends Controller
{
    ...
    public function markuserinvestment($status, $id)
    {
        Userinvestment::where('id', $id)->update([
            'active' => $status,
        ]);
        return redirect()->back()
            ->with('success', "Investment Active state changed to $status");
    }



    public function deleteuserinvestment($id)
    {
        Userinvestment::where('id', $id)->delete();
