...
class HomeController extends Controller
{
    ...
    {
    return view('admin.Plans.activeinvestment', [
        'title' => 'Active investment plans',
      'plans' => UserInvestment::whereIn('active', ['Pending', 'Processed','yes'])
    ->orderByDesc('id')
    ->with(['planDetails', 'investor'])
    ->get(),

    ]);
    }

 public function userinvestmentplan($id)
    {
        return view('admin.Users.userinvestmentplan')
            ->with(array(
                'plans' =>UserInvestment::where('user', $id)->orderBy('id', 'desc')->get(),
